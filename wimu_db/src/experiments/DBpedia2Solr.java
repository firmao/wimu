...
//		solr.commit();
		...
		Date date = new Date();
		System.out.println("DumpDBpedia2Solr...Parallel, starting: " + dateFormat.format(date));
		...
		date = new Date();
		System.out.println("DBpedia2Solr...Parallel, finalize at: " + dateFormat.format(date));
	}	
